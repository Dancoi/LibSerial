        ...
        <div className="mx-auto px-4 py-8 rounded-xl shadow-md">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <Link to="/search">
                        <button
                            ...
                            onClick={null} // замените на вашу функцию
                        >
                            Добавить сериал
                        </button>
                    </Link>
            ...
            {loading ? (
                ...
                <div className="text-center py-10">
                    <p className="text-gray-500 text-lg">Сериалов по вашему запросу не найдено. Попробуйте ещё раз или добавьте его сами!</p>
                    {error && (
